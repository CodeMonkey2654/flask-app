...
totalList = []  # Initialize totalList as a list of lists of DataFrames
max_length = 0  # Track the maximum length of inner lists

for month in df.groupby(df.index.month):
    dailyList = []
    for day in month[1].groupby(month[1].index.day):
        dailyList.append(day[1])  # Keep as DataFrame
        max_length = max(max_length, len(day[1]))  # Update max_length
    totalList.append(dailyList)

# No need to convert to NumPy array; keep totalList as a list of DataFrames
...
def get_selection(month, day, selection):
    ...
    # Access the original DataFrame for the specific month and day
    daily_data = totalList[month][day]  # This should be a DataFrame
    ...
    for i in range(24):
        ...
        yVal.append(len(daily_data[daily_data.index.hour == i]))  # Use the DataFrame's index
                ...
                html.Div(
                    ...
                    children=[
                        ...
                        html.P(
                            ...
                            different time frames on the histogram. Sourced from FiveThirtyEight."""
                        ),
                        html.Div(
